...
hero:
  ...
  tagline: Comprehensive documentation for our Angular component library and SaaS platform API. Production-ready components with full TypeScript support and accessibility built-in.
  actions: []
---
