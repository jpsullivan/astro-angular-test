...
<LandingHero title="ACDocs" tagline="Comprehensive documentation for our Angular component library and SaaS platform API. Build modern, accessible web applications with production-ready components.">
