  ...
  integrations: [
    starlight({
      ...
      logo: {
        ...
        replacesTitle: true, // Optional: Hide the text title if the logo includes it
      },
      social: [
        {
          label: "GitHub",
            ...
            { label: "Get Started Guide", link: "/start/get-started-guide/" },
            {
              ...
              items: [
                { label: "Overview", link: "/start/add-new-project/" },
                {
                  ...
                  link: "/start/add-new-project/deploy-from-template/",
                },
                {
                  label: "Deploy from Your Repository",
                  link: "/start/add-new-project/deploy-from-repository/",
                },
                {
                  label: "Deploy from AI Code Generation Tool",
                  link: "/start/add-new-project/deploy-from-ai-tool/",
                },
              ],
            },
            {
              label: "Pro Tips After Your First Deploy",
              link: "/start/pro-tips/",
            },
        ...
        },
        {
          ...
          items: [
            { label: "Deploy Overview", link: "/deploy/deploy-overview/" },
            {
              ...
              items: [
                { label: "Overview", link: "/deploy/compare-preview-options/" },
                {
                  ...
                  link: "/deploy/compare-preview-options/production-deploy/",
                },
                {
                  label: "Branch Deploys",
                  link: "/deploy/compare-preview-options/branch-deploys/",
                },
              ],
            },
            ...
            { label: "Protect Deploys", link: "/deploy/protect-deploys/" },
            {
              ...
              link: "/deploy/deploy-notifications/",
            },
            {
              label: "Review a Preview Server Instance",
              link: "/deploy/review-preview-server/",
            },
          ],
        },
        {
    ...
    angular({
      vite: {
        ...
        transformFilter: (_code, id) => {
          return (
            id.includes("src/components") || id.includes("src\\components")
          );
        },
        advanced: {
